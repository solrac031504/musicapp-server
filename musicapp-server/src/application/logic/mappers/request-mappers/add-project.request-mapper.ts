...
import { AddProjectRequest } from "../../services/project/add/add-project.request.ts";

export class AddProjectRequestMapper extends BaseRequestMapper<AddProjectRequest, ProjectModel> {
	public override map(req: AddProjectRequest): ProjectModel {
		return {
			id: req.item.id,
