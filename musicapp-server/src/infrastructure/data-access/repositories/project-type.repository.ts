...
export class ProjectTypeRepository extends Repository<ProjectTypeModel, ProjectTypeEntity, ProjectTypeEntityMapper, DataSource> {
    constructor(dataSource: DataSource) {
        super(dataSource, ProjectTypeEntity, new ProjectTypeEntityMapper);
    }

    protected override async findOneById(id: number): Promise<ProjectTypeEntity | null> {
