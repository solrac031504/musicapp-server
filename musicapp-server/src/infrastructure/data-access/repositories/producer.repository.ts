...
export class ProducerRepository extends Repository<ProducerModel, ProducerEntity, ProducerEntityMapper, DataSource> {
    constructor(dataSource: DataSource) {
        super(dataSource, ProducerEntity, new ProducerEntityMapper);
    }

    protected override async findOneById(id: number): Promise<ProducerEntity | null> {
