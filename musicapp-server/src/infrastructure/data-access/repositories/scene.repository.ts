...
export class SceneRepository extends Repository<SceneModel, SceneEntity, SceneEntityMapper, DataSource> {
    constructor(dataSource: DataSource) {
        super(dataSource, SceneEntity, new SceneEntityMapper);
    }

    protected override async findOneById(id: number): Promise<SceneEntity | null> {
