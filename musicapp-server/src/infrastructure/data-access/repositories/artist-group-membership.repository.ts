...
export class ArtistGroupMembershipRepository
    extends Repository<
        ArtistGroupMembershipModel,
        ArtistGroupMembershipEntity,
        ArtistGroupMembershipEntityMapper,
        DataSource
    > {
    constructor(dataSource: DataSource) {
        super(
            dataSource,
            ArtistGroupMembershipEntity,
            new ArtistGroupMembershipEntityMapper(),
        );
    }

    protected override async findOneById(
        id: number,
    ): Promise<ArtistGroupMembershipEntity | null> {
