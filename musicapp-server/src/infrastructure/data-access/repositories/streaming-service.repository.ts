...
export class StreamingServiceRepository extends Repository<StreamingServiceModel, StreamingServiceEntity, StreamingServiceEntityMapper, DataSource> {
    constructor(dataSource: DataSource) {
        super(dataSource, StreamingServiceEntity, new StreamingServiceEntityMapper);
    }

    protected override async findOneById(id: number): Promise<StreamingServiceEntity | null> {
