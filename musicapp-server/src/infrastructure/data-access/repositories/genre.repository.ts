...
export class GenreRepository extends Repository<GenreModel, GenreEntity, GenreEntityMapper, DataSource> {
    constructor(dataSource: DataSource) {
        super(dataSource, GenreEntity, new GenreEntityMapper);
    }

    protected override async findOneById(id: number): Promise<GenreEntity | null> {
