...
export class ProducerGroupMembershipRepository extends Repository<ProducerGroupMembershipModel, ProducerGroupMembershipEntity, ProducerGroupMembershipEntityMapper, DataSource> {
    constructor(dataSource: DataSource) {
        super(dataSource, ProducerGroupMembershipEntity, new ProducerGroupMembershipEntityMapper);
    }

    protected override async findOneById(id: number): Promise<ProducerGroupMembershipEntity | null> {
