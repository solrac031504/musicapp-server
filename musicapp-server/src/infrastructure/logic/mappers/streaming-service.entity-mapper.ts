...
export class StreamingServiceEntityMapper extends EntityMapper<StreamingServiceModel, StreamingServiceEntity> {
    public override toModel(entity: StreamingServiceEntity): StreamingServiceModel {
        return {
    ...
    public override fromModel(model: StreamingServiceModel): StreamingServiceEntity {
        return {
